...
fun SetBudgetView(
    ...
    )
    {
        ...
        Text(
            text = "set it first so we can set it up",
            fontSize = 18.sp,
            color = Color.Gray
        )
...
val token = "Bearer" + AuthRepository.ACCESS_TOKEN
                    // Use the token to set the budget
                    mainViewModel.setBudgetWants(budgetwants.toInt(),token)
                Log.d("Check budgetttT", budgetwants)
                    mainViewModel.setBudgetNeeds(budgetneeds.toInt(),token)
                Log.d("Check budgetttT", budgetneeds)
                    mainViewModel.setBudgetSavings(budgetsavings.toInt())
                Log.d("Check budgetttT", budgetsavings)
        ...
        Button(
            ...
            Text(
                text = "Have an account already click here",
                fontSize = 16.sp,
                fontWeight = FontWeight.SemiBold,
                color = Color.Blue
            )
